    ...
    <div className="container my-5">
      ...
      <div className="card shadow-lg">
        <div className="card-header" style={{border:"none"}}>
          <h2 className="mb-0 text-center-title text-white">{t("Management Staff Details")}</h2>
        </div>
        ...
        >
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              {i18n.language=='ar'?<> 
              {t("Are you sure you want to delete")} {t("'s record?")} {" "} {doctor.firstName}{" "} {doctor.lastName} </>:<>  {t("Are you sure you want to delete")} {doctor.firstName}{" "}
