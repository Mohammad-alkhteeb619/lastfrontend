...
export default function DoctorForm() {
  ...
  const [doctor, setDoctor] = useState({
    ...
    departmentid: "", // Default empty value for departmentid
  ...
  const handleSubmit = (e) => {
    ...
    axios
      ...
      .then((response) => {
                    ...
                    if(response.data.message == "creating operation successful...!!!"){
  ...
  return (
    <div className="container mt-5 mb-5">
      {toastMessage && <ToastMessage type="success" message={t("a New Doctor Added Successfully")} />}
