...
export default function DoctorDetails() {
  ...
  return (
    <div className="container my-5">
      ...
      <h2 className="mb-0 text-center-title text-white">{t("Pharmacist Details")}</h2>
        </div>
         ...
         <div className="row">
            ...
            {doctor.gender !== undefined && (
              <div className="col-md-6 mb-4">
                ...
                <p>{doctor.gender ? t("Male") : t("Female")}</p>
              </div>
            )}
            {doctor.email && (
              <div className="col-md-6 mb-4">
          ...
          <div className="mt-4 d-flex gap-2">
            <button
              type="button"
              className="major-btn"
              onClick={() => navigate(`/update-pharmacist/${id}`)}
            >
              {t("Edit")}
            </button>
            <button
          ...
          <div className="modal-dialog">
            <div className="modal-content">
              ...
              <div className="modal-body">
                ...
                {i18n.language=='ar'?<>  {t("Are you sure you want to delete")} {t("'s record?")}{" "}{doctor.firstName}{" "}
                {doctor.lastName} </>:<>  {t("Are you sure you want to delete")} {doctor.firstName}{" "}
