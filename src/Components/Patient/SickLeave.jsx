...
const SickLeaveDetails = () => {
  ...
  return (
    <div className="container mt-4">
      <h2 className="text-center-title text-white mb-4 col-md-6 mx-auto" style={{ maxWidth: "500px" }}>{t("Sick Leave Details")}</h2>
      <div className="card mx-auto" style={{ maxWidth: "500px" }}>
        <div className="card-body">
          <p>
            <strong className="form-label">{t("Duration")} ({t("Days")}):</strong> {sickLeave.duration}
          </p>
          <p>
          ...
          <p>
            <strong className="form-label">{t("Reason")}:</strong> {sickLeave.reason}
          </p>
          <p>
            <strong className="form-label">{t("Created At")}:</strong>{" "}{new Date(sickLeave.createdAt).toLocaleString()}            
